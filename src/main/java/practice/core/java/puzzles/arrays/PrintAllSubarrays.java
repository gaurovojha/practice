...
class PrintallSubarrays
{
    ...
    // in the given array
    public static void printallSubarraysWithZeroSum(int[] A)
    {
        ...
        for (int i = 0; i < A.length; i++)
        {
            ...
            System.out.println("sum: "+ sum + " *** " + "value: "+i);
    ...
    {
        int[] A = { 4, 3, -7, 3, 1, 3, 1, -4, -2, -2 };

        //printallSubarraysWithZeroSum(A);
        printallSubarraysWithGivenSum(A);
    }


    public static void printallSubarraysWithGivenSum(int[] A)
    {
        // create an empty Multi-map to store ending index of all
        // sub-arrays having same sum
        Map<Integer, List<Integer>> hashMap = new HashMap<>();
